...
declare class SeekStream {
     ...
     * @param options Options provided to stream function.
     */
    constructor(url: string, duration: number, headerLength: number, contentLength: number, video_url: string, options: StreamOptions);
    /**
     * **INTERNAL Function**
     *
 ...
 * @returns Deciphered Video Info {@link InfoData}
 */
declare function decipher_info<T extends InfoData | StreamInfoData>(data: T): Promise<T>;
/**
